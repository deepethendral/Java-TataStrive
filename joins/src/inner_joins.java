...
public class inner_joins {
    public static void main(String[] args) {
        ...
        String innerJoinQuery = 
            ...
            "INNER JOIN products_table p ON e.emp_id = p.product_id";

        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection(url, username, password);
            PreparedStatement pst = con.prepareStatement(innerJoinQuery);
            ...
            while (rs.next()) {
                ...
                System.out.printf("%-8d %-15s %-10d %-20s %-15s%n",
                                  empId, empName, prodId, prodName, brand);
            }
